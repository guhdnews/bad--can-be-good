...
export default function About() {
  return (
    <>
      <Head>
        <title>About - News Can Be Good</title>
        <meta name="description" content="Learn about News Can Be Good - your source for positive news and uplifting stories from around the world." />
      </Head>
