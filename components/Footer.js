      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="mb-4">
              <LogoCompact className="filter brightness-110" />
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Transforming the way we consume news by focusing on positive stories that inspire, uplift, and remind us of the good in the world.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} News Can Be Good. All rights reserved.
            </p>
