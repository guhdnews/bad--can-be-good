...
export default function Newsletter() {
  ...
  return (
    <section id="newsletter" className="bg-gradient-to-r from-blue-600 via-blue-700 to-green-600 rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="mx-auto max-w-2xl text-center">
          {!subscribed ? (
            <>
              ...
              {/* Benefits */}
              <div className="mt-8 grid gap-4 sm:grid-cols-3 text-sm text-blue-100">
                ...
                <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border-0 bg-white/20 backdrop-blur-sm px-4 py-4 text-white placeholder:text-blue-200 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600 text-lg"
                      disabled={loading}
                    />
                  </div>
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-shrink-0 rounded-lg bg-white px-8 py-4 text-lg font-semibold text-blue-600 shadow-sm hover:bg-blue-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white disabled:opacity-70 transition-all duration-200"
                  >
                    {loading ? (
